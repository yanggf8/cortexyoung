...
- **Scale**: 150 files, 37347 LOC [config(76), rust(71), shell(2), typescript(1)]

### Directory structure
```
tests/ (1 files, 1023 LOC)
Total: 74 files, 37347 LOC (code)
```
...
- `rust/src/main.rs` (2066 LOC, rust)  — 32:const KNOWN_COMMANDS; 51:fn usage_value; 79:fn wants_help; 84:fn map_index; 100:struct IdxWrap; 102:impl impl IdxWrap; 103:fn fmt; 108:impl impl IdxWrap; 109:fn sqlite_code; 117:struct CortWrap; 119:impl impl CortWrap; 120:fn fmt; 125:impl impl CortWrap; 126:fn sqlite_code; 131:fn unwrap_busy; 142:fn open_project_tracked; 168:fn open_project_unmigrated; 187:struct UsageEvent; 199:struct Emit; 205:fn usage_from_args; 225:fn fill_stale; 229:fn stored_omitted_len; 243:fn finish_record; 262:fn render_emit; 281:fn resolve_fmt; 286:fn parse_usize_flag; 292:fn parse_i64_flag; 298:fn parse_line_flag; 309:fn clap_fail; 320:fn content_mode_name; 328:fn cwd; 338:struct IndexArgs; 352:struct RootArgs; 364:struct HookSuggestArgs; 380:struct HookInstallArgs; 431:struct FormatOnlyArgs; 442:struct ProjectsArgs; 456:struct InternalShimArgs; 467:struct StructArgs; 486:struct ContextArgs; 504:struct ImpactArgs; 523:struct ReadArgs; 541:struct RecallArgs; 557:struct UsageArgs; 564:fn pin_bin; 570:fn dispatch; 622:fn hook_row; 633:fn hook_args; 639:fn hook_args_decline; 645:fn hook_args_kind; 651:fn hook_args_tag; 660:fn model_of_payload; 693:fn harness_of; 722:fn search_of_payload; 757:fn gate_already_fired; 815:fn cmd_hook_refresh; 964:fn cmd_hook_suggest; 1164:const HOOK_GIT_BUDGET_MS; 1167:enum IndexState; 1189:fn git_head_quickly; 1200:fn probe_index; 1231:fn map_json_settings_err; 1242:fn map_toml_settings_err; 1262:enum SettingsFormat; 1268:fn settings_format; 1293:fn default_settings_path_for; 1330:const HOOK_TARGETS; 1344:fn hook_install_all; 1418:fn render_hook_entries_lean; 1474:fn status_of_entry; 1489:fn install_into; 1508:fn remove_from; 1518:fn cmd_internal_shim; 1527:fn cmd_internal_ast_grep; 1541:fn cmd_internal_manifest_keys; 1552:fn cmd_hook_install; 1653:fn cmd_index; 1716:fn cmd_status; 1783:fn cmd_projects; 1865:fn cmd_delete; 1910:fn cmd_struct; 1953:fn cmd_context; 1989:fn cmd_impact; 2016:fn cmd_read; 2065:fn cmd_recall; 2096:fn cmd_usage; 2111:fn peek_format; 2134:fn main
...
- `tests/install-smoke.sh` (1023 LOC, shell)
...
*Generated at 2026-09-07T05:36:50Z by claudecat* — facts from manifests + AST; framework/entry may be inferred from deps/paths where manifest lacks them.
<!-- claudecat:auto:end -->
