...
misses. The project map is maintained by the same tool (`claudecat update`), which writes it to
this machine's data folder (`~/.local/share/claudecat/projects/<project-id>/map.md`) and never
