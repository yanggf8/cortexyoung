...
const DEFAULT_TTL_MS = Number.parseInt(process.env.CORTEX_CHUNK_TTL_MS ?? "1200000", 10); // 20 minutes
const MAX_CACHE_ENTRIES = Number.isFinite(Number(process.env.CORTEX_CHUNK_MAX_ENTRIES)) ? Number(process.env.CORTEX_CHUNK_MAX_ENTRIES) : 500;
